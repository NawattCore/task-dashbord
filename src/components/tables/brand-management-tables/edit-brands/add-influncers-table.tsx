...
export default function AddInfluencersTable() {
      ...
      render: () => (
        <div className="flex items-center justify-center ">
          <Button
            ...
            className="max-md:w-full rounded-3xl "
          >
            <Add size="32" color="#1DA1F2" className="size-6" />
            إضافة المؤثر
          </Button>
        </div>
      ),
    ...
    <div className="w-full  h-full overflow-auto">
      <SimpleTable<Influencer>
        ...
        styles={{
          ...
          table: `border-0 rounded-2xl text-center transition-all duration-300  w-full h-[450px] max-lg:h-auto overflow-auto pl-4 `,
        ...
        <div className="flex justify-between items-center flex-wrap gap-5 border-gray-700/50 rounded-t-2xl">
          ...
          <div className="flex flex-col gap-2 items-start  max-lg:mb-4 text-right flex-1">
            <div className="text-xl text-white font-medium  max-md:text-[16px] ">
              {' '}
              إضافة مؤثرين من قاعدة البيانات
            </div>
          ...
          <div className="relative max-md:w-full col-span-2">
            <Input
              type="text"
              className="pr-14 rounded-3xl w-[500px] max-md:w-full  max-md:text-sm "
